...
function HeroPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#071522] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(25,57,95,0.3),_transparent_34%),linear-gradient(90deg,_rgba(2,10,16,0.96),_rgba(8,17,25,0.8)_72%,_rgba(64,49,34,0.35))]" />
      <div className="absolute inset-y-0 left-1/2 w-[62rem] -translate-x-[58%] rounded-full bg-[radial-gradient(circle,_rgba(25,84,143,0.3)_0%,_rgba(4,13,22,0.94)_45%,_rgba(3,9,15,0)_68%)] blur-sm" />
